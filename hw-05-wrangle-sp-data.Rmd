...
In this homework we revisit the Denny's and La Quinta Inn and Suites data we visualized in a previous lab.
...
**There are a total of 6 pairings***
...
**There are a total of 6 observations, which are from the Denny's dataframe**
...
**We can use the mutate function to add a new variable**
